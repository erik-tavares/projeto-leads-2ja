  ...
  return (
    <>
      ...
      <section className="px-8 py-4">
        <h1 className="uppercase mt-4 mb-8 text-4xl text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="flex">
            <p className="mr-4 cursor-pointer">
              Carrinho de Compras ({cart.totalQantity})
            </p>
          ...
          <div>
            <StripeCheckout
              ...
              billingAddress
              shippingAddress
              description={`Seu Total é ${cart.totalPrice}`}
              amount={cart.totalPrice * 100}
              currency="USD"
              token={onToken}
        ...
        <div className="my-12 grid gap-8 lg:grid-cols-[2fr_1fr]">
          ...
          <div>
            <div className="border rounded-xl p-4">
              <h1 className="uppercase text-4xl mb-8">Ordem de Compras</h1>
              <div className="flex justify-between mb-8">
                <span className="capitalize">Subtotal</span>
                <span>R$ {cart.totalPrice}</span>
              </div>
              <div className="flex justify-between mb-8">
                <span className="capitalize"> Total do Pedido</span>
                <span>R$ 00.00</span>
              </div>
              <div className="flex justify-between mb-8">
                <span className="capitalize">Desconto de Compras</span>
                <span>-R$ 00.00</span>
              </div>
              <div className="flex justify-between mb-8">
                <span className="capitalize font-bold text-2xl">Total</span>
                <span className="font-bold text-2xl">R$ {cart.totalPrice}</span>
              </div>
            </div>
          </div>
        </div>
